...
export default function index({allItems, selectedItems, action}) {
    ...
    const customList = (items) => (
        <Paper sx={{ width: '100%', height: 430, overflow: 'auto' }}>
            <List dense component="div" role="list" disablePadding sx={{"padding":"1px","margin":"1px"}}>
                    ...
                    return (
                        ...
                        >
                            <ListItemIcon sx={{"padding":"1px","height":"35px","width":"100%", "margin":"0px"}}>
                                <ListItemText  primaryTypographyProps={{fontSize: '14px'}}   id={labelId} primary={`${value.name}`} sx={{ margin:"0px", backgroundColor:"rgb(251, 251, 251)", width:'100%',padding:"5px",}} onClick={()=>handleColorChange(labelId)} />
                            </ListItemIcon>
