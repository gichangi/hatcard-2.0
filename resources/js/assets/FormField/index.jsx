...
class index extends Component {
    ...
    // initialize state
    state = { value: this.props.initValue != null?this.props.initValue:'', dirty: false, errors: [] };
        ...
        return (
            <Fragment>
                <div className="form-group px-3 pb-2">
                    ...
                    {children}
                    <input type={type} className={controlClass} id={fieldId} placeholder={placeholder} value={this.state.value} onChange={this.hasChanged} autoComplete="new-password"/>
                </div>
            </Fragment>
        );
    }
