...
function EquityUploadData({pageSwitch, uploadId}) {
    ...
    useEffect(()=>{
        if(uploadId != null){
            apiFetch('GET',{},`/api/equity-data/data/${uploadId}`,{}).then(res=>{
                setData(res.data.equity_data);
                setUploadInfo(
                    {
                        upload_id:uploadId,
                        data:res.data.equity_data
                    }
                )
            })
...
export default EquityUploadData;
