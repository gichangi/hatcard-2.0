    ...
    return (
        <>
            <Grid container spacing={1} direction="row" alignItems="center" style={{ backgroundColor: 'white' }}>
                <Grid item xs={isDesktop ? 7 : 12} style={{ height: '100vh' }}>
                            ...
                            <Card className="borderless text-center" style={{ boxShadow: 'none', width: '35rem' }}>
                                <Card.Body>
                                    ...
                                    <Grid container spacing={1} direction="row" alignItems="center" justifyContent="space-around">
                                        <Grid item xs={3}>
                                            <img src="images/pepfar2.png" alt="image" style={{ height: isDesktop ? '4rem' : '2rem', width: isDesktop ? '8rem' : '4rem' }} />
                                        </Grid>
                                        <Grid item xs={3}>
                                            <img src="images/usaid.jpg" alt="image" style={{ height: isDesktop ? '4rem' : '2rem', width: isDesktop ? '8rem' : '4rem' }} />
                                        </Grid>
                                        <Grid item xs={3}>
                                            <img src="images/DataFI.png" alt="image" style={{ height: isDesktop ? '4rem' : '2rem', width: isDesktop ? '8rem' : '4rem' }} />
                                        </Grid>
                                    </Grid>
                                </Card.Body>
                            </Card>
                ...
                {isDesktop ? (<Grid item xs={isDesktop ? 5 : 0} sx={{ backgroundColor: '#fff', height: '100vh' }}>
